...
export default function EventModal({ event, isOpen, onClose, onSuccess }) {
  ...
  const updateKeyInformation = (index, value) => {
    setFormData((prev) => ({
      ...prev,
      keyInformation: prev.keyInformation.map((item, i) =>
        i === index ? value : item
      ),
    }));
  };
  ...
  return (
    <div className="modal-overlay">
      <div className="bg-white rounded-lg p-6 max-w-4xl w-full max-h-[90vh] overflow-y-auto modal-animation modal-content">
              ...
              {formData.keyInformation.map((info, index) => (
                <div key={index} className="flex gap-4">
                  ...
                  <input
                    ...
                    value={info}
                    onChange={(e) =>
                      updateKeyInformation(index, e.target.value)
                    }
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        value={source.from}
                        onChange={(e) =>
                          updateSource(index, "from", e.target.value)
                        }
                        className="w-full px-3 py-2 border rounded-md"
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={source.topic}
                        onChange={(e) =>
                          updateSource(index, "topic", e.target.value)
                        }
                        className="w-full px-3 py-2 border rounded-md"
