      ...
      {isDeleteDialogOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-lg p-6 max-w-sm w-full">
            <h3 className="text-lg font-semibold mb-2">Delete Upcoming Event</h3>
            <p className="text-gray-600 mb-4">Are you sure you want to delete this upcoming event? This action cannot be undone.</p>
