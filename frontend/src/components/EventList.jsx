...
const initialEvents = [
  {
    ...
    description: "A three-day conference featuring keynote speakers, workshops, and networking opportunities focused on artificial intelligence and machine learning.",
    images: "https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3",
    keyInformation: [
    ...
    informationSource: [
      ...
      { from: "https://techconference2023.example.com", topic: "Conference Website" }
    ]
  },
  {
    id: 2,
    ...
    description: "A hands-on workshop covering React, Vue, and other modern web development tools and techniques.",
    images: "https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3",
    peopleInformation: {
      info1: ["Sarah Johnson - React Expert", "Mike Brown - Vue Specialist"],
      info2: ["Morning Session - React Fundamentals", "Afternoon Session - Vue.js"],
  ...
  },
  {
    ...
    description: "Learn how to create and maintain design systems that scale across large applications.",
    images: "https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3",
    peopleInformation: {
    ...
    <>
      ...
      {isDeleteDialogOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-lg p-6 max-w-sm w-full modal-animation">
          ...
          <div className="max-w-7xl mx-auto px-4 py-6 modal-animation">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div>
                ...
                <p className="text-xl text-gray-600 mb-8">{selectedEvent.subtitle}</p>
                ...
                <div className="space-y-8">
                  ...
                  <section>
                    ...
                    <div className="space-y-4">
                      {selectedEvent.keyInformation && selectedEvent.keyInformation.map((info, index) => (
                        <div key={index} className="flex gap-4">
                          <span className="text-gray-500">{index + 1}</span>
                          <p>{info}</p>
                        </div>
                      ))}
                      {selectedEvent.peopleInformation && Object.entries(selectedEvent.peopleInformation).map(([key, items], index) => (
                        <div key={key} className="space-y-2">
                          <h4 className="font-medium">Information Point {index + 1}</h4>
                  ...
                  <section>
                    <h2 className="text-2xl font-semibold mb-4">Information Sources</h2>
                          ...
                          <div className="mb-2">
                            ...
                            <p className="text-gray-600">
                              {source.from.startsWith('http') ? (
                                <a href={source.from} className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">
                                  {source.from}
                                </a>
                              ) : (
                                source.from
