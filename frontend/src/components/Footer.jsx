      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-1">
            <div className="mb-8">
              ...
              <h4 className="text-lg font-serif font-bold mb-2">ARCADIA</h4>
          ...
          {/* Column 2 */}
          <div className="md:col-span-1">
            <h3 className="text-xl font-serif font-bold mb-4">Events</h3>
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-gray-600 text-sm mb-4">gsm.arcadia@gmail.com</p>
        ...
        <div className="pt-5 border-t border-gray-200 flex justify-center items-center">
          <div className="text-center">
            ...
            />
            <div className="text-gray-500 text-xs">© Arcadia</div>
          </div>
        </div>
      </div>
    </footer>
